...
server.unifiedServer = function(req,res) {
    ...
    req.on('end', () => {
        ...
        //if the request is in public directory use public handler insted
        ...
        try {
            chooseHandler(data, function(statusCode, payload, contentTyoe) {
                server.processHandlerResponse(res, method, trimmedPath, statusCode, payload, contentTyoe);
            });
        } catch(e) {
            debug(e);
...
server.processHandlerResponse = function(res, method, trimmedPath, statusCode, payload, contentTyoe) {
